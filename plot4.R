...
par(mfrow=c(2,2))
plot(ds$Time, as.numeric(ds$Global_active_power), type="l", lty=1, col="black", ylab="Global Active Power", xlab="")
plot(ds$Time, as.numeric(ds$Voltage), type="l", lty=1, col="black", ylab="Global Active Power", xlab="datetime")
...
plot(ds$Time, as.numeric(ds$Global_reactive_power), type="l", lty=1, col="black", ylab="Global_reactive_power", xlab="datetime")
dev.off()